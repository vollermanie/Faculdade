...
<body>
                        ...
                        <tbody>
                            <c:forEach var="paises" items="${lista}">
                                <tr>
                                    ...
                                    <td class="actions">
                                         <a class="btn btn-success btn-xs" href="ManterPaises.do?area=${paises.area}&populacao=${paises.populacao}&acao=Visualizar&id=${paises.id }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="ManterPaises.do?area=${paises.area}&populacao=${paises.populacao}&acao=Editar&id=${paises.id }">Editar</a>
                                        <button id="btn${paises.id }%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-paises="${paises.id}">Excluir</button>
                                    </td>
                                </tr>
                            </c:forEach>
    ...
    <script type="text/javascript">
        $("#delete-modal").on('show.bs.modal', function (event) {
            ...
            var recipient = button.data('paises');
